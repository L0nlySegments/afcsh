 ...
 * With modifications from Allen Porter, Scott Turner and L0nlySegments
 *
 * ------------------------------------------------------------------------- */
...
/* File Formats */
#define ST_IFMT "st_ifmt"
#define ST_NLINK "st_nlink"
#define ST_SIZE "st_size"
#define ST_BLOCKS "st_blocks"
#define ST_MTIME "st_mtime"
#define ST_BIRTHTIME "st_birthtime"
...
typedef struct afc_file {
    afc_file_ref file_ref;
    int mode; 
    long size;
} afc_file;

typedef struct afc_file_info {
    unsigned short a_st_ifmt; /* S_IFDIR, S_IFREG, S_IFLNK */
    int a_st_nlink;
    unsigned long a_st_size;
    int a_st_blocks;
    time_t a_st_mtime;
    time_t a_st_birthtime;
} afc_file_info;
